...
const Dashboard = () => {
  return (
    <div className="relative bg-ghostwhite w-full h-[1024px] overflow-hidden text-left text-sm text-light-bulma1 font-paragraph-text-md-s">
      <div className="absolute top-[calc(50%_-_472px)] left-[43px] w-[280px] h-[944px] text-lg text-light-goten font-montserrat">
      ...
      <div className="absolute top-[699px] left-[390px] w-[480px] h-64 font-montserrat">
      ...
      <div className="absolute top-[485.95px] left-[910px] w-[480px] h-[469.05px]">
        <div className="absolute top-[213.05px] left-[0px] w-[480px] h-64">
          <div className="absolute h-[101.56%] w-[100.83%] top-[-0.78%] right-[-0.42%] bottom-[-0.78%] left-[-0.42%] rounded-xl bg-light-goten shadow-[4px_4px_20px_rgba(0,_0,_0,_0.1)] box-border border-[2px] border-solid border-gainsboro-100" />
        </div>
        <img
          className="absolute h-[1.12%] w-[1.04%] top-[0%] right-[6.25%] bottom-[98.88%] left-[92.71%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/undefined13.png"
        />
      </div>
      ...
      <div className="absolute top-[71px] left-[390px] w-[1000px] h-[32.93px] text-5xl font-montserrat">
      ...
      <div className="absolute top-[829px] left-[949px] flex flex-row items-center justify-start gap-[12px] text-light-bulma">
        <img
          className="relative rounded-165xl w-7 h-7 overflow-hidden shrink-0 object-cover"
          alt=""
          src="/undefined16.png"
        />
        <div className="relative [text-decoration:underline] leading-[24px]">
          +91 29938 81234
        </div>
      </div>
      <div className="absolute top-[879px] left-[949px] flex flex-row items-center justify-start gap-[12px] text-light-bulma">
        <img
          className="relative rounded-165xl w-7 h-7 overflow-hidden shrink-0 object-cover"
          alt=""
          src="/undefined17.png"
      ...
      <div className="absolute top-[829px] left-[1193px] flex flex-row items-center justify-start gap-[12px] text-light-bulma">
        <img
          className="relative rounded-[164px] w-7 h-7 overflow-hidden shrink-0 object-cover"
          alt=""
          src="/undefined18.png"
        />
        <div className="relative [text-decoration:underline] leading-[24px]">
      ...
      <div className="absolute top-[879px] left-[1194px] flex flex-row items-start justify-start gap-[12px] text-light-bulma">
        <img
          className="relative rounded-165xl w-7 h-7 overflow-hidden shrink-0 object-cover"
          alt=""
          src="/undefined19.png"
      ...
      <div className="absolute top-[747px] left-[951px] flex flex-col items-start justify-center text-5xl">
        <div className="flex flex-col items-start justify-center">
          <div className="relative leading-[24px] font-semibold">John Doe</div>
        </div>
      </div>
      <img
