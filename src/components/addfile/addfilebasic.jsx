  ...
  return (
    <div className="relative bg-ghostwhite w-full h-[1024px] overflow-hidden text-left text-sm text-light-bulma1 font-montserrat">
      <div className="absolute top-[calc(50%_-_472px)] left-[43px] w-[280px] h-[944px] text-lg text-light-goten">
        ...
        h<div className="absolute top-[43.64%] left-[31.43%]">Settings</div>
      ...
      <div className="absolute top-[140.5px] left-[390px] w-[1000px] flex flex-row items-start justify-start gap-[17px] text-2xs font-lato">
        <div className="relative w-[237.32px] h-[120px]">
          ...
          <img
            className="absolute h-[14.37%] w-[7.86%] top-[20.54%] right-[78.05%] bottom-[65.09%] left-[14.08%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined8.png"
          />
        </div>
        <div className="relative w-[237.32px] h-[120px]">
          ...
          <img
            className="absolute h-[14.33%] w-[6.28%] top-[21.35%] right-[78.85%] bottom-[64.31%] left-[14.88%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined9.png"
          />
        ...
        <div className="relative w-[237.32px] h-[120px]">
          ...
          <img
            className="absolute h-[14.17%] w-[6.95%] top-[20.66%] right-[79.85%] bottom-[65.17%] left-[13.2%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined10.png"
          />
        </div>
        <div className="relative w-[237.32px] h-[120px]">
          ...
          <img
            className="absolute h-[10.97%] w-[8.51%] top-[23.03%] right-[78.94%] bottom-[66%] left-[12.55%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined11.png"
          />
        </div>
      ...
      <div className="absolute top-[242px] left-[390px] w-[1000px] h-[418.33px] font-lato">
        ...
        <div className="absolute top-[0px] left-[40px] w-[124px] h-[133.33px] text-secondary-text font-montserrat">
          ...
          <img
            className="absolute h-[2.47%] w-[6.45%] top-[0%] right-[0%] bottom-[97.53%] left-[93.55%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined12.png"
          />
        </div>
      ...
      <img
        className="absolute h-[0.52%] w-[0.35%] top-[47.46%] right-[5.56%] bottom-[52.03%] left-[94.1%] max-w-full overflow-hidden max-h-full object-cover"
        alt=""
        src="/undefined32.png"
      />
      ...
      <div className="absolute top-[71px] left-[390px] w-[1000px] h-[32.93px] text-5xl">
        ...
        <div className="absolute top-[0px] left-[713px] w-[197.6px] h-[32.93px] text-sm text-light-grey font-lato">
          ...
          <img
            className="absolute top-[9px] left-[153px] w-[12.71px] h-3 object-cover"
            alt=""
            src="/undefined14.png"
          />
        </div>
        ...
        />
        <img
          className="absolute h-[63.43%] w-[1.8%] top-[19.91%] right-[5.76%] bottom-[16.67%] left-[92.44%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/undefined15.png"
        />
      </div>
      <img
        className="absolute h-[19.04%] top-[40.53%] bottom-[40.43%] left-[calc(50%_-_167.22px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined20.png"
      />
      <img
        className="absolute h-[13.47%] top-[46.13%] bottom-[40.4%] left-[calc(50%_+_29.64px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined21.png"
      />
      <img
        className="absolute h-[15.35%] top-[44.24%] bottom-[40.4%] left-[calc(50%_+_429.64px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined22.png"
      />
      <img
        className="absolute h-[7.51%] top-[52.08%] bottom-[40.4%] left-[calc(50%_+_229px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined23.png"
      />
      <img
        className="absolute h-[15.23%] top-[44.47%] bottom-[40.3%] left-[calc(50%_-_118.91px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined24.png"
      />
      <img
        className="absolute h-[17.1%] top-[42.6%] bottom-[40.3%] left-[calc(50%_+_77.95px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined25.png"
      />
      <img
        className="absolute h-[13.03%] top-[46.67%] bottom-[40.3%] left-[calc(50%_+_477.95px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined26.png"
      />
      <img
        className="absolute h-[11.43%] top-[48.27%] bottom-[40.3%] left-[calc(50%_+_277.32px)] rounded max-h-full w-[38.41px] object-cover"
        alt=""
        src="/undefined27.png"
      />
      <div className="absolute top-[775px] left-[430px] w-[141.98px] h-[141.98px]">
        <div className="absolute top-[0px] left-[0px] w-[141.98px] h-[141.98px]">
          <img
            className="absolute h-[99.93%] w-[72.39%] top-[-0.11%] right-[43.65%] bottom-[0.18%] left-[-16.04%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/undefined35.png"
          />
        ...
        <img
          className="relative w-[79.22px] h-[141.97px] object-cover"
          alt=""
          src="/undefined29.png"
        />
        <img
          className="relative w-[76.84px] h-[79.45px] object-cover"
          alt=""
          src="/undefined36.png"
        />
        <img
          className="absolute h-[11.34%] w-[11.67%] top-[88.53%] right-[47.87%] bottom-[0.13%] left-[40.46%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/undefined31.png"
        />
      </div>
      <div className="absolute top-[699px] left-[910px] w-[480px] h-64 text-base text-secondary-text font-paragraph-text-md-s">
        ...
        <div className="absolute h-[45.62%] w-[17.08%] top-[27.19%] right-[41.46%] bottom-[27.19%] left-[41.46%] flex flex-col items-center justify-center gap-[16px]">
          <img
            className="relative w-[76.78px] h-[76.78px] object-cover"
            alt=""
            src="/undefined37.png"
          />
      ...
      <div className="absolute top-[calc(50%_-_512px)] left-[calc(50%_-_720px)] bg-gray w-[1440px] h-[1024px]" />
      <div className="absolute top-[calc(50%_-_276.5px)] left-[calc(50%_-_272px)] rounded-2xl bg-light-goten shadow-[0px_32px_32px_-8px_rgba(0,_0,_0,_0.08),_0px_0px_32px_-8px_rgba(0,_0,_0,_0.12),_0px_0px_1px_rgba(0,_0,_0,_0.2)] w-[544px] h-[553px] text-xl text-light-bulma font-paragraph-text-md-s">
        <div className="absolute top-[0px] left-[0px] w-[544px] h-16 flex flex-col pt-4 px-0 pb-0 box-border items-center justify-between">
          <div className="self-stretch flex flex-row py-0 px-6 items-center justify-between">
            <div className="self-stretch relative leading-[32px] font-semibold flex items-center w-[252px] shrink-0">
              Add New Profile
            </div>
            <div className="rounded-lg overflow-hidden flex flex-row p-1 items-center justify-start">
              <img
          ...
          <div className="self-stretch relative box-border h-px border-t-[1px] border-solid border-light-beerus-beerus" />
        </div>
        <div className="absolute top-[63px] left-[0px] w-[544px] h-[376px] flex flex-col p-6 box-border items-start justify-start gap-[24px] text-base">
          <div className="relative w-[480px] h-10">
            <div className="absolute top-[-0.37px] left-[275px] w-[213px]" />
            <div className="absolute top-[2.85%] left-[18.12%] leading-[24px] font-semibold">
              Basic
            </div>
            <div className="absolute top-[2.85%] left-[71.52%] leading-[24px] font-semibold">
              Contact
            </div>
            <div className="absolute top-[37.14px] left-[-0.25px] rounded-11xl bg-dodgerblue-100 w-[213.42px] h-1" />
            <div className="absolute top-[37.14px] left-[266.58px] rounded-11xl bg-gainsboro-200 w-[213.42px] h-1" />
          </div>
          <div className="flex flex-col items-start justify-start">
            <div className="w-[496px] flex flex-col items-start justify-start gap-[8px]">
              <div className="self-stretch relative leading-[24px]">
                Enter Name*
              </div>
              <div className="self-stretch rounded-lg bg-light-goten flex flex-col py-3 px-4 items-start justify-start text-light-trunks border-[1px] border-solid border-light-beerus-beerus">
                <div className="self-stretch relative leading-[24px]">
                  Eg. John Doe
                </div>
              </div>
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[8px] text-light-bulma1">
            <div className="self-stretch relative leading-[24px]">
              Enter Email*
            </div>
            <div className="self-stretch rounded-lg bg-light-goten overflow-hidden flex flex-row p-3 items-center justify-between text-center text-3xs text-light-goten border-[1px] border-solid border-light-beerus-beerus">
              <div className="hidden flex-row items-start justify-start gap-[4px]">
                <div className="rounded bg-light-piccolo-piccolo overflow-hidden flex flex-row py-1 pr-1 pl-2 items-center justify-start gap-[4px]">
                  <div className="relative tracking-[0.5px] leading-[16px] uppercase font-semibold">
                    TAG 1
                  </div>
                  <img
                ...
                <div className="rounded bg-light-piccolo-piccolo overflow-hidden hidden flex-row py-1 pr-1 pl-2 items-center justify-start gap-[4px]">
                  <div className="relative tracking-[0.5px] leading-[16px] uppercase font-semibold">
                    your label
                  </div>
                  <img
              ...
              <div className="relative text-base leading-[24px] text-light-trunks text-left">
                Eg. John@xyz.com
              </div>
        ...
        <div className="absolute top-[465px] left-[4px] w-[544px] h-[88px] text-center text-sm text-light-trunks font-avertastd-semibold">
          <div className="absolute top-[-0.25px] left-[-0.25px] box-border w-[544.5px] h-[0.5px] border-t-[0.5px] border-solid border-light-beerus-beerus" />
          <div className="absolute top-[24px] left-[0px] w-[544px] flex flex-row py-0 px-6 box-border items-center justify-between">
            <div className="rounded-lg overflow-hidden flex flex-row py-2 px-4 items-center justify-center">
              <div className="relative leading-[24px]" />
            </div>
            <div className="flex flex-row items-start justify-start text-light-goten font-paragraph-text-md-s">
              <div className="relative rounded-lg bg-dodgerblue-200 w-16 h-10 overflow-hidden shrink-0">
                <div className="absolute top-[8px] left-[16px] leading-[24px] font-semibold">
                  Next
                </div>
              </div>
            </div>
