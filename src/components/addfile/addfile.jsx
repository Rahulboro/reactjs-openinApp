const Dashboard1 = () => {
  return (
    <div className="relative bg-ghostwhite w-full h-[1024px] overflow-hidden text-left text-sm text-light-bulma1 font-montserrat">
      ...
      <div className="absolute top-[calc(50%_-_231.5px)] left-[calc(50%_-_272px)] rounded-2xl bg-light-goten shadow-[0px_32px_32px_-8px_rgba(0,_0,_0,_0.08),_0px_0px_32px_-8px_rgba(0,_0,_0,_0.12),_0px_0px_1px_rgba(0,_0,_0,_0.2)] w-[544px] h-[463px] flex flex-col items-start justify-start text-xl text-light-bulma font-paragraph-text-md-s">
        <div className="self-stretch h-16 flex flex-col pt-4 px-0 pb-0 box-border items-center justify-between">
        ...
        <div className="self-stretch flex flex-col p-6 items-start justify-start gap-[24px] text-base">
          <div className="relative w-[480px] h-10">
            ...
            <div className="absolute top-[2.85%] left-[73.19%] leading-[24px] font-semibold">
              Social
            </div>
            <div className="absolute top-[37.14px] left-[-0.25px] rounded-11xl bg-gainsboro-200 w-[213.42px] h-1" />
            <div className="absolute top-[37.14px] left-[266.58px] rounded-11xl bg-dodgerblue-100 w-[213.42px] h-1" />
          </div>
          <div className="flex flex-col items-start justify-start">
            <div className="w-[496px] flex flex-col items-start justify-start gap-[8px]">
              <div className="self-stretch relative leading-[24px]">
                <span>{`Instagram Link `}</span>
                <span className="text-light-trunks">{`(Optional)  `}</span>
              </div>
          ...
          <div className="w-[496px] flex flex-col items-start justify-start">
            <div className="self-stretch relative leading-[24px]">
        ...
        <div className="self-stretch h-[88px] flex flex-col pt-0 px-0 pb-6 box-border items-start justify-start gap-[24px] text-center text-sm text-light-trunks font-avertastd-semibold">
          <div className="self-stretch relative box-border h-[0.5px] border-t-[0.5px] border-solid border-light-beerus-beerus" />
          <div className="self-stretch flex flex-row py-0 px-6 items-center justify-between">
            <div className="rounded-lg overflow-hidden flex flex-row py-2 px-4 items-center justify-center">
              <div className="relative leading-[24px]" />
            </div>
            <div className="flex flex-row items-start justify-start gap-[8px] text-light-bulma font-paragraph-text-md-s">
              <div className="rounded-lg overflow-hidden flex flex-row py-2 px-4 items-center justify-center border-[1px] border-solid border-light-trunks">
                <div className="relative leading-[24px] font-semibold">
                  Back
                </div>
              </div>
              <div className="rounded-lg bg-dodgerblue-100 overflow-hidden flex flex-row py-2 px-4 items-center justify-center text-light-goten">
                <div className="relative leading-[24px] font-semibold">
                  Done
                </div>
              </div>
